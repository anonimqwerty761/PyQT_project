...
class AboutDialog(QDialog):
    def __init__(self):
        ...
        layout.addWidget(QLabel("Version 20.11.2008"))
        layout.addWidget(QLabel("Copyright 2024 Lyceum 145"))
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        about_action.setStatusTip("Find out more about LMS yandex")  
        ...
        navigate_mozarella_action.setStatusTip("Go to LMS yandex Homepage")
        ...
        self.setWindowTitle("LMS yandex")
    ...
    def update_title(self, browser):
        ...
        self.setWindowTitle("%s - LMS yandex" % title)

    def navigate_mozarella(self):
        self.tabs.currentWidget().setUrl(QUrl("https://lms.yandex.ru/"))
...
if __name__ == "__main__":
    ...
    app.setApplicationName("LMS yandex")
    app.setOrganizationName("Lyceum145")
    app.setOrganizationDomain("ya.ru")
